...
public class AmazonStepdefinitions {
    ...
    public void aramaKutusunaIhoneProYazipAratir(int arg0) {
        amazonPage.aramaKutusu.sendKeys("iphone 15 Pro"+Keys.ENTER);

    }

    @Then("arama sonuclarinin sonuc sayisini yazdir")
    public void arama_sonuclarinin_sonuc_sayisini_yazdir() {

        String sonucDeger = amazonPage.sonucYaziElementi.getText();
        System.out.println(sonucDeger);
